					...
					<section className="tagLineContent2 text-tertiary h-auto items-center justify-between lg:mx-auto lg:min-w-[40rem] lg:justify-evenly xl:w-full">
						<section className="mx-auto grid h-auto w-fit md:w-full md:grid-cols-2 lg:gap-7 xl:grid-cols-4">
							<div className="flex h-32 w-60 items-center gap-5 lg:w-80">
								<div className="stroke-text border-secondary hover:text-primary text-[75px] leading-[87px] font-semibold text-transparent transition duration-500 ease-in-out lg:text-[100px] xl:text-[120px]">
									2+
								</div>
								<div className="text-tertiary hover:text-secondary flex w-fit flex-col text-left text-2xl leading-10 transition duration-500 ease-in-out">
									Years Experience
								</div>
							</div>
							<div className="flex h-32 w-60 items-center gap-5 lg:w-80">
								...
								<span className="text-tertiary hover:text-secondary flex flex-col text-left text-2xl leading-10 transition duration-500 ease-in-out">
									Advanced Tools
								</span>
							</div>
							<div className="flex h-32 w-60 items-center gap-5 lg:w-80">
								<div className="stroke-text border-secondary hover:text-primary text-[75px] leading-[87px] font-semibold text-transparent transition duration-700 ease-in-out lg:text-[100px] xl:text-[120px]">
									10+
								</div>
								<span className="text-tertiary hover:text-secondary flex flex-col text-left text-2xl leading-10 transition duration-700 ease-in-out">
									Satisfied Clients
								</span>
							</div>
							<div className="flex h-32 w-60 items-center gap-5 lg:w-80">
