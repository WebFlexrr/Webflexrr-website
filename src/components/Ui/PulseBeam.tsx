...
export const PulseBeams = (): React.JSX.Element => {
	return (
		<div className="relative flex h-[40rem] items-center justify-center overflow-hidden bg-slate-950 antialiased">
...
export const SVGs = (): React.JSX.Element => {
	return (
		<svg
			width="858"
			height="434"
...
const GradientColors = (): React.JSX.Element => {
	return (
		<>
